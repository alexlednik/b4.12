...
def get_user_data():
	...
	birthyear = input("Your year of birth (e.g. 1990): ")
	birthmonth = input("Your month of birth (e.g. 04): ")
	birthday = input("Your day of birth (e.g. 01): ")
	height = input("Your height in meters (e.g. 1.82): ")
